...
const Opportunity = () => {
  let opportunities = [
    {
      key: "Practice",
      detail: "Sharpen your abilities and enhance your knowledge in our hands-on practice section. Get ready to learn by doing!",
      button: "Explore More",
    },
    {
      key: "Learn",
    ...
    {
      key: "Test",
      detail: "Ready to put your skills to the test? Take on the challenge and showcase your expertise with our interactive skill assessment!",
      button: "Check Now",
    },
    {
      key: "Mentorships",
  ...
  return (
    <div className='mt-[450px] pt-72  w-full  h-fit text-black-200  bg-cover bg-black-400 md:bg-[url("https://firebasestorage.googleapis.com/v0/b/hostel-entry-system.appspot.com/o/layered-waves-haikei.svg?alt=media&token=04c39ad5-7e81-4a41-b714-eb52b80f9d30")]  bg-[url("https://firebasestorage.googleapis.com/v0/b/hostel-entry-system.appspot.com/o/layered-waves-haikei%20(1).svg?alt=media&token=82771e32-4226-4ddf-a438-7ec2d17cb57e")]'>
      ...
      <div className="w-full md:h-[35vh] h-fit mt-20 gap-8 text-black-200 md:px-20 mx-auto  bg-[#eeeecc] grid grid-cols-1  md:grid-cols-4 ">
        ...
        //   <Reveal>
            <div className="fill-card p-4 mx-auto" key={index}>
              <h2>{item.key}</h2>
